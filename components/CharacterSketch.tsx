export const CharacterSketch = () => {
  ...
  const data = [
    { id: 1, name: "Sherlock Holmes", personality: "Analytical, observant, logical" },
    { id: 2, name: "Tony Stark", personality: "Genius, sarcastic, confident" },
    { id: 3, name: "Hermione Granger", personality: "Intelligent, disciplined, loyal" },
    { id: 4, name: "Batman", personality: "Brooding, strategic, justice-driven" },
    { id: 5, name: "Naruto Uzumaki", personality: "Energetic, determined, optimistic" },
  ];
      ...
      <div className="w-full max-w-2xl mx-auto mt-6 rounded-sm border bg-white shadow-sm overflow-hidden">
        <table className="w-full text-sm">
          ...
          <thead className="bg-gray-100 text-gray-600 uppercase text-base tracking-wider">
            <tr>
              <th className="px-6 py-3 text-left font-serif border-r">Character</th>
